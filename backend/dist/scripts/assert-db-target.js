...
verifyDbTargetOrExit({
    prefix: '[db-target]',
    onMissingTarget: () => console.log('[db-target] DATABASE_URL no está definido o no se pudo interpretar como una URL válida.'),
    failureMessage: '[db-target] Comando abortado: DATABASE_URL no coincide con la base de datos de v2 declarada en ' +
