...
export function buildInvitationEmail(data) {
    ...
    return emailShell('Invitación a Pamir', intro, tabla, 'Este correo es una notificación automática del sistema PAMIR. Si no esperabas esta invitación, puedes ignorar este mensaje.', cta);
}
// ─── Eventos del club ─────────────────────────────────────────────────────────
