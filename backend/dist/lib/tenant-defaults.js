...
export const DEFAULT_CATEGORIAS_EVENTO = [
...
export const DEFAULT_DECLARACION_ITEMS = [
...
export function computeDeclaracionHash(titulo, items) {
...
export function buildDefaultDeclaracion(org) {
    void org;
    return {
