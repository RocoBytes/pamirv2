...
import { createSalida, getSalidas, getSalidaById, updateSalida, updateSalidaIntegrantes, deleteSalida, getSalidaArchivoUrl, } from '../controllers/salidas.controller.js';
const router = Router();
