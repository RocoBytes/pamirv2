...
import { getStats, getDashboard, getSaludSalida, enviarSaludSalida, getDashboardLayout, saveDashboardLayout, deleteDashboardLayout, getGoogleCredencial, saveGoogleCredencial, } from '../controllers/admin.controller.js';
const router = Router();
