...
// requireAdmin/requireCanInvite solo miran req.user.rol, pero AuthUser exige
// organization: se completa con datos neutros para que estos fakes sigan
// calzando con el tipo real.
const FAKE_ORG = {
  id: 'org-1',
  slug: 'club-fake',
  name: 'Club Fake',
  shortName: null,
  membresiaPropia: 'SOCIO_CLUB_FAKE',
  alertEmail: 'alertas@club-fake.cl',
  contactName: 'Contacto Fake',
  contactEmail: 'contacto@club-fake.cl',
};
