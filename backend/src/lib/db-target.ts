...
export function describeTarget(databaseUrl: string): { host: string; database: string } | null {
  try {
...
export function isAllowedTarget(databaseUrl: string | undefined, fragment: string | undefined): boolean {
