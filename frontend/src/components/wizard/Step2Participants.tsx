...
export function Step2Participants({ defaultValues, onSubmit, onBack, isAdmin = false }: Step2Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-6">
      ...
      <div className="rounded-2xl border border-secondary/15 bg-surface-container-low/60 p-4 flex flex-col gap-4">
        <Controller
          name="avisosExternos"
          control={control}
          render={({ field }) => (
          ...
          <div className="flex flex-col gap-1.5 pl-1">
            ...
            <input
              ...
              className={[
                ...
                errors.retenCarabineros ? 'border-error' : 'border-secondary/30',
              ].join(' ')}
            />
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={[
                    'w-full px-3 py-2.5 rounded-xl border bg-white text-sm text-slate-800',
                    'placeholder:text-outline focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-shadow',
                    errors.nombreFamiliar ? 'border-error' : 'border-secondary/30',
                  ].join(' ')}
                />
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={[
                    'w-full px-3 py-2.5 rounded-xl border bg-white text-sm text-slate-800',
                    'placeholder:text-outline focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-shadow',
                    errors.telefonoFamiliar ? 'border-error' : 'border-secondary/30',
                  ].join(' ')}
                />
